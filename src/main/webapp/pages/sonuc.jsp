...
<html lang="">
<head>
<title>Hipotez 1 Sonuç Sayfası</title>
<meta charset="utf-8">
<meta name="viewport"
				...
				<div class="scrollable">
					<table>
						...
						<tbody>
							...
							double x1 = 0;
							double x2 = 0;
							if (rs.getDouble(2) == 1.618) {
								x1 = 1.618 - rs.getDouble(2);
							} else if (rs.getDouble(2) < 1.618 && rs.getDouble(2) > 1.518) {
								x1 = 1.618 - rs.getDouble(2);
							} else if (rs.getDouble(2) < 1.518 && rs.getDouble(2) > 1.418) {
								x1 = 1.518 - rs.getDouble(2);
							} else if (rs.getDouble(2) < 1.418 && rs.getDouble(2) > 1) {
								x1 = 1.418 - rs.getDouble(2);
							} else if (rs.getDouble(2) < 1.718 && rs.getDouble(2) > 1.618) {
								x1 = 1.718 - rs.getDouble(2);
							} else if (rs.getDouble(2) < 1.818 && rs.getDouble(2) > 1.718) {
								x1 = 1.818 - rs.getDouble(2);
							} else if (rs.getDouble(2) < 2 && rs.getDouble(2) > 1.818) {
								x1 = (rs.getDouble(2) - 1.818);
							}
							x2 = x1 * 25;
								...
								<td><br>
									...
									<div class="progress">
										<div class="progress-bar progress-bar-striped bg-warning"
											role="progressbar"
											style="width:<%=(rs.getDouble(2) * 100) - 120%>%"
									...
									<div class="progress">
										<div class="progress-bar progress-bar-striped bg-danger"
											role="progressbar"
											style="width: <%=(rs.getDouble(3) * 100) - 120%>%"
